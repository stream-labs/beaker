...
let ItemGrid$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$2 = function render() {
  ...
  return _c("div", { staticClass: "s-item-grid" }, [_vm._t("default")], 2);
};
...
const ItemGrid = __component__$2.exports;
...
var _sfc_render$1 = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "s-virtual-item", class: [_vm.virtualItemClasses], attrs: { "rarity": _vm.rarity, "selected": _vm.selected, "quantity": _vm.quantity, "value": _vm.value }, on: { "click": function($event) {
    return _vm.$emit("click");
  } } }, [_vm.selectionCount ? _c("span", { staticClass: "s-virtual-item__selection-count" }, [_vm._v(" " + _vm._s(_vm.selectionCount) + " ")]) : _vm._e(), _vm.remainingTime ? _c("span", { staticClass: "s-virtual-item__selection-remaining", class: { warning: _vm.hasWarning } }, [_vm._v(_vm._s(_vm.remainingTime))]) : _vm._e(), _vm.type ? _c("span", { staticClass: "s-virtual-item__label" }, [_vm._v(_vm._s(_vm.type))]) : _vm._e(), _vm.quantity ? _c("span", { staticClass: "s-virtual-item__label" }, [_vm._v(_vm._s(_vm.quantity))]) : _vm._e(), _c("div", { staticClass: "s-virtual-item__img" }, [_c("img", { attrs: { "src": _vm.preview } })]), _c("h3", { staticClass: "s-virtual-item__name" }, [_vm._v(_vm._s(_vm.name))]), _c("span", { staticClass: "s-virtual-item__rarity", class: { entered: _vm.isGiveaway } }, [_vm.isGiveaway ? _c("i", { staticClass: "icon-check-mark" }) : _vm._e(), _vm._v(" " + _vm._s(_vm.rarity) + " ")])]);
};
...
const VirtualItem = __component__$1.exports;
...
let VirtualItems$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
const VirtualItems_vue_vue_type_style_index_0_scoped_b46ebb50_lang = "";
var _sfc_render = function render3() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Virtual Items")]), _c("p", [_vm._v("UI for face masks items and grid.")]), _vm._m(0), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Giveaway Items")]), _c("DemoSection", { attrs: { "title": "Giveaway Items", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "container" }, [_c("VirtualItem", { attrs: { "preview": _vm.itemImage, "rarity": "Enter Giveaway", "name": "4x VIP Tickets to PAX, TwitchCon and SXSW", "remainingTime": "2h left", "hasWarning": true } }), _c("VirtualItem", { attrs: { "preview": _vm.itemImage, "rarity": "Entered", "name": "$5K Custom High-Spec Streaming Desktop PC", "remainingTime": "5d left", "isGiveaway": true } })], 1)];
  }, proxy: true }]) })], 1), _c("h2", [_vm._v("Face Masks")]), _c("DemoSection", { attrs: { "title": "Face Masks", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ItemGrid", _vm._l(_vm.masks, function(mask, id) {
      return _c("VirtualItem", { key: id, attrs: { "preview": mask.preview, "rarity": mask.rarity, "name": mask.name, "selectionCount": mask.selectionCount, "selected": mask.selected }, on: { "click": _vm.clickEvent } });
    }), 1)];
...
const VirtualItems = __component__.exports;
export {
  VirtualItems as default
};
