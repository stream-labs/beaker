...
import { M as ModalComp } from "./ModalComp.12fcb69e.js";
...
let Modals$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render = function render() {
  ...
  return _c("div", [_vm._m(0), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Modal Basic")]), _c("DemoSection", { attrs: { "title": "Modal Basic", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ModalComp", { attrs: { "name": "modal-basic", "type": "basic", "title": "UI Modal", "subTitle": "Subtitle", "clickToClose": false, "text": "\n              Save combining multiple windows like Streamlabels, Twitch Chat,\n              Twitch Dashboard, Video, Streamlabs Dashboard, OBS etc into a\n              live view.\n            " } }, [_vm._v("Slots Available!")])];
  }, proxy: true }]) }), _c("div", { staticClass: "s-button-container--left" }, [_c("Button", { attrs: { "variation": "default", "title": "modal basic" }, on: { "click": function($event) {
    return _vm.$modal.show("modal-basic");
  } } })], 1)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Modal Subscribe")]), _c("p", [_vm._v("Used once subscribe.")]), _c("DemoSection", { attrs: { "title": "Modal Subscribe", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ModalComp", { attrs: { "type": "subscribe", "scrollable": true, "title": "Streamlabs", "subTitle": "Never pay for GIFs and effects again!", "text": "\n              Get unlimited free GIFs and effects that will show up on all\n              alerts on all channels! You\u2019ll also get a fancy \u2018Pro\u2019 badge next\n              to your username on your donations.\n            ", "subscribe-text": "galazy83 donated $50.00!", "subscribe-message": "Thanks for the stream. Go CivRyan!", "notes": "You may cancel your subscription at any time." } })];
  }, proxy: true }]) }), _c("div", { staticClass: "button-container button-container--left" }, [_c("Button", { attrs: { "variation": "default", "title": "modal subscribe" }, on: { "click": function($event) {
    return _vm.$modal.show("modal-subscribe");
  } } })], 1)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Modal Redirect")]), _c("p", [_vm._v("Used for redirect.")]), _c("DemoSection", { attrs: { "title": "Modal Redirect", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ModalComp", { attrs: { "type": "redirect", "title": "Redirecting...", "text": "\n              Redirecting you to PayPal to update your method of payment.\n              Click here if you have been waiting longer than 5 seconds.\n            " } })];
  }, proxy: true }]) }), _c("div", { staticClass: "button-container button-container--left" }, [_c("Button", { attrs: { "variation": "default", "title": "modal redirect" }, on: { "click": function($event) {
    return _vm.$modal.show("modal-redirect");
  } } })], 1)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Modal Confirm")]), _c("p", [_vm._v("Used when needed to let the user confirm.")]), _c("DemoSection", { attrs: { "title": "Modal Confirm", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ModalComp", { attrs: { "type": "confirmation", "width": 400, "subTitle": "Delete \u2018Streamlabs Pillow'", "text": "\n              Are you sure you want to delete the merch item \u2018Streamlabs\n              Pillow\u2019? This action cannot be undone.\n            ", "confirmButtonText": "Delete" }, on: { "confirm": () => {
    } } })];
  }, proxy: true }]) }), _c("div", { staticClass: "button-container button-container--left" }, [_c("Button", { attrs: { "variation": "warning", "title": "modal confirmation" }, on: { "click": function($event) {
    return _vm.$modal.show("modal-confirmation");
  } } })], 1)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Modal Welcome Prime")]), _c("p", [_vm._v("Used for welcome prime")]), _c("DemoSection", { attrs: { "title": "Modal Welcome Prime", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ModalComp", { attrs: { "type": "welcome-prime", "width": 600, "hasPrimeCloseButton": true }, on: { "onClickPrime": _vm.test } })];
  }, proxy: true }]) }), _c("div", { staticClass: "button-container button-container--left" }, [_c("Button", { attrs: { "variation": "default", "title": "modal welcome prime" }, on: { "click": function($event) {
...
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Modal")]), _c("pre", [_c("code", [_vm._v("import { ModalComp } from 'streamlabs-beaker';\n\ncomponents: {\n  ModalComp\n}")])])]);
}, function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
...
const Modals = __component__.exports;
export {
  Modals as default
};
