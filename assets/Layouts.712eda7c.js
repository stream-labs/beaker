...
let ContentRow$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$1 = function render() {
  ...
  return _c("div", { staticClass: "s-content-row", class: _vm.contentRowMq }, [_c("div", { staticClass: "s-content-box", class: _vm.contentBoxMq }, [_vm.icon ? _c("i", { staticClass: "s-banner__icon", class: `icon-${_vm.icon}` }) : _vm._e(), _c("h2", { staticClass: "s-content__title", class: _vm.contentTitleMq }, [_vm._t("title")], 2), _c("p", { staticClass: "s-content__text", class: _vm.contentTextMq }, [_vm._t("text")], 2)]), _c("div", { staticClass: "s-button-container" }, [_c("Button", { attrs: { "size": "fixed-width", "variation": _vm.btnVariation, "title": _vm.btnTitle, "onClick": "buttonClick", "href": _vm.buttonHref, "to": _vm.buttonTo, "tag": _vm.buttonTag } })], 1)]);
};
...
const ContentRow = __component__$1.exports;
...
let Layouts$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_vm._m(0), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Content Row")]), _c("p", [_vm._v("Used for content row.")]), _c("DemoSection", { attrs: { "title": "Content Row", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ContentRow", { attrs: { "icon": "desktop", "btnVariation": "default", "btnTitle": "Default" } }, [_c("span", { attrs: { "slot": "title" }, slot: "title" }, [_vm._v("Tiltify")]), _c("span", { attrs: { "slot": "text" }, slot: "text" }, [_vm._v(" Link your account and visit Alert Box to configure your Tiltify Events. ")])])];
  }, proxy: true }]) }), _c("ContentRow", { attrs: { "icon": "education", "btnVariation": "action", "btnTitle": "Action" } }, [_c("template", { slot: "title" }, [_vm._v("Tiltify")]), _c("template", { slot: "text" }, [_vm._v("Link your account and visit Alert Box to configure your Tiltify Events.")])], 2)], 1), _vm._m(1)]);
};
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Content Row")]), _c("pre", [_c("code", [_vm._v("import { ContentRow } from 'streamlabs-beaker';\n\ncomponents: {\n  ContentRow\n}")])])]);
}, function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
...
const Layouts = __component__.exports;
export {
  Layouts as default
};
