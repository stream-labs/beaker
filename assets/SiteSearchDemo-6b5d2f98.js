var f=Object.defineProperty;var v=(e,s,t)=>s in e?f(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t;var n=(e,s,t)=>(v(e,typeof s!="symbol"?s+"":s,t),t);import{W as m,C as g,P as h,V as b,n as y}from"./index-e8bb31bb.js";import{A as w}from"./Accordion-79d22a9d.js";import{D as S}from"./DemoSection-b2dfe451.js";import{F as k}from"./fuse.esm-88e2763d.js";var _=Object.defineProperty,C=Object.getOwnPropertyDescriptor,l=(e,s,t,a)=>{for(var i=a>1?void 0:a?C(s,t):s,o=e.length-1,c;o>=0;o--)(c=e[o])&&(i=(a?c(s,t,i):c(i))||i);return a&&i&&_(s,t,i),i};let r=class extends b{constructor(){super(...arguments);n(this,"$refs");n(this,"result",[]);n(this,"isOpen",!1);n(this,"phaseOne",!1);n(this,"phaseTwo",!1);n(this,"resultLimit",7);n(this,"fuse",null);n(this,"value","");n(this,"quickLinkLoc",[]);n(this,"keyEvents",[]);n(this,"currentResult",0);n(this,"jsonSearch");n(this,"searchData",this.jsonSearch);n(this,"search");n(this,"eventName");n(this,"inputChangeEventName");n(this,"quickLinks")}get suggestedLinks(){return this.quickLinks.filter(t=>{let a=this.searchData.find(o=>o.name===t.item.name),i=this.searchData.indexOf(a);return this.quickLinkLoc.push(i),i})}get options(){return{isCaseSensitive:!1,includeMatches:!0,includeScore:!0,findAllMatches:!0,shouldSort:!0,threshold:.3,location:0,distance:35,maxPatternLength:16,minMatchCharLength:1,keys:[{name:"keywords",weight:.3},{name:"title",weight:.7}]}}get noResults(){return this.result.length===0&&this.value!=""}get limitedResult(){return this.resultLimit?this.result.slice(0,this.resultLimit):this.result}get calcHeight(){return this.phaseOne===!1?"height: 40px;":this.result.length>=1&&this.result.length<=7&&this.phaseOne==!0?"height: "+(parseInt(this.result.length)*32+47)+"px;":"height: 271px;"}watchSearchData(){this.fuse.searchData=this.searchData,this.fuseSearch()}watchSearch(){this.value=this.search}watchValue(){this.$parent.$emit(this.inputChangeEventName,this.value),this.$emit(this.inputChangeEventName,this.value),this.fuseSearch()}watchResult(t,a){(this.noResults||this.value==""||t.length!=a.length)&&(this.currentResult=0),this.$emit(this.eventName,this.result),this.$parent.$emit(this.eventName,this.result)}keyEvent(t){t.keyCode===38&&this.currentResult>0&&this.currentResult--,this.result.length===0?t.keyCode===40&&this.currentResult<5&&this.currentResult++:t.keyCode===40&&this.currentResult<6&&this.currentResult++,t.keyCode===13&&this.phaseOne&&(this.result<=0?(this.trackEvent(this.currentResult),window.location.href=this.searchData[this.quickLinkLoc[this.currentResult]].route,this.blurSearch()):(this.trackEvent(this.currentResult),window.location.href=this.limitedResult[this.currentResult].item.route,this.blurSearch())),t.keyCode===27&&this.phaseOne&&this.blurSearch()}trackEvent(t){this.$emit("trackSearchNav",t)}playClosingSequence(){this.phaseTwo&&(setTimeout(()=>{this.phaseTwo=!this.phaseTwo},100),setTimeout(()=>{this.phaseOne=!this.phaseOne},200))}playOpeningSequence(){this.phaseOne||(this.phaseOne=!this.phaseOne,setTimeout(()=>{this.phaseTwo=!this.phaseTwo},100))}initFuse(){this.fuse=new k(this.searchData,this.options),this.search&&(this.value=this.search)}blurSearch(){this.value="",this.$refs.search_input.blur(),this.currentResult=0}fuseSearch(){this.value.trim()===""?this.result=[]:this.result=this.fuse.search(this.value.trim())}mounted(){this.searchData=this.jsonSearch,this.initFuse()}};l([h()],r.prototype,"jsonSearch",2);l([h({default:""})],r.prototype,"search",2);l([h({default:"fuseResultsUpdated"})],r.prototype,"eventName",2);l([h({default:"fuseInputChanged"})],r.prototype,"inputChangeEventName",2);l([h()],r.prototype,"quickLinks",2);l([m("searchData")],r.prototype,"watchSearchData",1);l([m("search")],r.prototype,"watchSearch",1);l([m("value")],r.prototype,"watchValue",1);l([m("result")],r.prototype,"watchResult",1);r=l([g({})],r);var D=function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("div",{staticClass:"s-sitesearch",class:[{"s-sitesearch--is-open":e.isOpen},{"s-sitesearch--phase-one":e.phaseOne},{"s-sitesearch--phase-two":e.phaseTwo}],style:e.calcHeight},[t("div",{staticClass:"s-sitesearch--searchbar__cont"},[e._m(0),t("input",{directives:[{name:"model",rawName:"v-model",value:e.value,expression:"value"}],ref:"search_input",staticClass:"s-sitesearch__input",attrs:{type:"text",placeholder:"Search Streamlabs..."},domProps:{value:e.value},on:{focus:function(a){return a.stopPropagation(),a.preventDefault(),e.playOpeningSequence.apply(null,arguments)},blur:function(a){return a.stopPropagation(),a.preventDefault(),e.playClosingSequence.apply(null,arguments)},keyup:function(a){return a.stopPropagation(),a.preventDefault(),e.keyEvent.apply(null,arguments)},input:function(a){a.target.composing||(e.value=a.target.value)}}})]),t("transition-group",{attrs:{name:"s-sitesearch--fadeY"}},[e.phaseTwo&&e.limitedResult.length<=0?t("div",{key:e.limitedResult.length,staticClass:"s-sitesearch-results__cont"},[t("div",{staticClass:"s-sitesearch-quicklinks"},[e._v("Quick Links")]),e._l(e.suggestedLinks,function(a,i){return t("a",{key:a.item.name,staticClass:"s-sitesearch-results",class:{"s-active-result":e.currentResult===i},attrs:{href:e.searchData[e.quickLinkLoc[i]].route},on:{mouseover:function(o){e.currentResult=i},mousedown:function(o){return e.trackEvent(e.searchData[e.quickLinkLoc[i]].route)},mouseup:e.blurSearch}},[t("div",{staticClass:"s-sitesearch__result--image"},[t("i",{staticClass:"s-sitesearch__result--image",class:e.searchData[e.quickLinkLoc[i]].image})]),t("div",{staticClass:"s-sitesearch__result--title"},[e._v(" "+e._s(e.searchData[e.quickLinkLoc[i]].title)+" ")])])})],2):e._e(),e.phaseTwo&&e.limitedResult.length>=1?t("div",{key:e.limitedResult.length,staticClass:"s-sitesearch-results__cont"},[t("transition-group",{attrs:{name:"s-sitesearch--fadeX"}},e._l(e.limitedResult,function(a,i){return t("a",{key:a.item.name,staticClass:"s-sitesearch-results",class:{"s-active-result":e.currentResult===i},attrs:{href:a.item.route},on:{mouseover:function(o){e.currentResult=i},mousedown:function(o){return e.trackEvent(e.searchData[e.quickLinkLoc[i]].route)},mouseup:e.blurSearch}},[t("div",{staticClass:"s-sitesearch__result--image"},[t("i",{staticClass:"s-sitesearch__result--image",class:a.item.image})]),t("div",{staticClass:"s-sitesearch__result--title"},[e._v(" "+e._s(a.item.title)+" ")])])}),0)],1):e._e()])],1)},x=[function(){var e=this,s=e.$createElement,t=e._self._c||s;return t("div",{staticClass:"s-sitesearch--icon"},[t("i",{staticClass:"icon-search"})])}];const d={};var q=y(r,D,x,!1,j,null,null,null);function j(e){for(let s in d)this[s]=d[s]}const L=function(){return q.exports}(),O=`<template>
  <div>
    <div class="section">
      <h1>Site Search</h1>
      <p>
