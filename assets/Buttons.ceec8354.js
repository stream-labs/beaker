...
const Buttons_vue_vue_type_style_index_0_scoped_4164de1f_lang = "";
var _sfc_render = function render() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_vm._m(0), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Standard Buttons")]), _c("p", [_vm._v("Used throughout website Dashboard.")]), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Active")]), _c("DemoSection", { attrs: { "title": "Active", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "variation": "default", "title": "Default", "tag": "a", "href": "https://laravel.com/docs/5.8/routing" } }), _c("Button", { attrs: { "variation": "action", "title": "Action" }, on: { "click": function($event) {
      return _vm.buttonClick("Action");
    } } }), _c("Button", { attrs: { "variation": "warning", "title": "Warning" }, on: { "click": function($event) {
      return _vm.buttonClick("Warning");
    } } }), _c("Button", { attrs: { "variation": "default", "title": "With icon", "icon": "add-circle" }, on: { "click": function($event) {
      return _vm.buttonClick("With icon");
    } } }), _c("Button", { attrs: { "variation": "default", "title": "Custom Colors", "bg-color": "pink", "text-color": "red" }, on: { "click": function($event) {
      return _vm.buttonClick("Custom Colors");
    } } }), _c("Button", { attrs: { "variation": "prime", "title": "Join Prime", "icon": "prime" }, on: { "click": function($event) {
      return _vm.buttonClick("Join Prime");
    } } }), _c("Button", { attrs: { "variation": "prime-white", "title": "Join Prime", "icon": "prime" }, on: { "click": function($event) {
      return _vm.buttonClick("Join Prime");
    } } }), _c("Button", { attrs: { "variation": "ultra", "title": "Join Ultra", "icon": "ultra" }, on: { "click": function($event) {
      return _vm.buttonClick("Join Ultra");
    } } }), _c("Button", { attrs: { "variation": "action" }, on: { "click": function($event) {
      return _vm.buttonClick("Custom Slot");
    } } }, [_c("div", { staticClass: "custom-html", attrs: { "slot": "custom" }, slot: "custom" }, [_c("i", { staticClass: "icon-add-circle" }), _c("span", [_vm._v("Custom Slot")])])])], 1)];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Disabled")]), _c("DemoSection", { attrs: { "title": "Disabled", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "variation": "default", "state": "disabled", "title": "Default" } }), _c("Button", { attrs: { "variation": "action", "state": "disabled", "title": "Action" } }), _c("Button", { attrs: { "variation": "warning", "state": "disabled", "title": "Warning" } }), _c("Button", { attrs: { "variation": "default", "state": "disabled", "title": "with icon", "icon": "edit" } })], 1)];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Focus")]), _c("DemoSection", { attrs: { "title": "Focus", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "variation": "default", "state": "focused", "title": "Default" } }), _c("Button", { attrs: { "variation": "action", "state": "focused", "title": "Action" } }), _c("Button", { attrs: { "variation": "warning", "state": "focused", "title": "Warning" } }), _c("Button", { attrs: { "variation": "default", "state": "focused", "title": "with icon", "icon": "edit" } })], 1)];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Loading")]), _c("DemoSection", { attrs: { "title": "Loading", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "variation": "default", "state": "loading", "title": "Default" } }), _c("Button", { attrs: { "variation": "action", "state": "loading", "title": "Action" } }), _c("Button", { attrs: { "variation": "warning", "state": "loading", "title": "Warning" } }), _c("Button", { attrs: { "variation": "default", "state": "loading", "title": "with icon", "icon": "recent-events" } })], 1)];
  }, proxy: true }]) }), _c("p", [_vm._v(" Click "), _c("a", { on: { "click": function($event) {
    _vm.isLoadingExample = !_vm.isLoadingExample;
  } } }, [_vm._v("here")]), _vm._v(" to test. ")]), _c("Button", { class: { "is-loading": _vm.isLoadingExample }, attrs: { "type": "button", "variation": "default", "title": "with icon", "icon": "pop-out-1" } })], 1)]), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Small Buttons")]), _c("p", [_vm._v(" Small is the size used on Streamlabs OBS. It is slightly smaller than our standard button. ")]), _c("DemoSection", { attrs: { "title": "Small Buttons", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "type": "button", "size": "small", "variation": "default", "title": "Default" } }), _c("Button", { attrs: { "type": "button", "size": "small", "variation": "action", "title": "Action" } }), _c("Button", { attrs: { "type": "button", "size": "small", "variation": "warning", "title": "Warning" } }), _c("Button", { attrs: { "type": "button", "size": "small", "variation": "default", "title": "With Icon", "icon": "image" } }), _c("Button", { attrs: { "variation": "rewards-standard", "size": "small", "title": "Rewards" } })], 1)];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Large Buttons")]), _c("p", [_vm._v(" Used on website marketing pages and for the Donate button on the tip page. ")]), _c("DemoSection", { attrs: { "title": "Large Buttons", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "type": "button", "size": "large", "variation": "default", "title": "Default" } }), _c("Button", { attrs: { "type": "button", "size": "large", "variation": "action", "title": "Action" } }), _c("Button", { attrs: { "type": "button", "size": "large", "variation": "warning", "title": "Warning" } }), _c("Button", { attrs: { "type": "button", "size": "large", "variation": "default", "title": "With Icon", "icon": "image" } }), _c("Button", { attrs: { "size": "large", "variation": "prime", "title": "Join Prime", "icon": "prime" } }), _c("Button", { attrs: { "size": "large", "variation": "prime-white", "title": "Join Prime", "icon": "prime" } }), _c("Button", { attrs: { "size": "large", "variation": "ultra", "title": "Join Ultra", "icon": "ultra" } })], 1)];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Fixed Width Buttons")]), _c("p", [_vm._v("Used throughout website Dashboard. Width is fixed at 96px.")]), _c("DemoSection", { attrs: { "title": "Fixed Width Buttons", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "type": "button", "size": "fixed-width", "variation": "default", "title": "Default" } }), _c("Button", { attrs: { "type": "button", "size": "fixed-width", "variation": "action", "title": "Action" } }), _c("Button", { attrs: { "type": "button", "size": "fixed-width", "variation": "warning", "title": "Warning" } }), _c("Button", { attrs: { "type": "button", "size": "fixed-width", "variation": "default", "title": "'WithIcon", "icon": "image" } })], 1)];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Full-Width Buttons")]), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Default")]), _c("p", [_vm._v("Used within cards and panels in the Dashboard.")]), _c("DemoSection", { attrs: { "title": "Default", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("Button", { attrs: { "size": "full-width", "variation": "default", "title": "Start Giveaway" } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Subscribe")]), _c("p", [_vm._v("Used on the App Platform for Subscribing to Apps.")]), _c("DemoSection", { attrs: { "title": "Subscribe", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("Button", { attrs: { "variation": "subscribe", "title": "Subscribe", "price": "$4.99" } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Paypal")]), _c("p", [_vm._v("Used on the Tip Page for Subscribing to Pro.")]), _c("DemoSection", { attrs: { "title": "Paypal", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("Button", { attrs: { "variation": "paypal", "title": "Subscribe with PayPal", "price": "$4.99" } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Download")]), _c("p", [_vm._v("Used for Download Streamlabs OBS buttons.")]), _c("DemoSection", { attrs: { "title": "Download", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "variation": "slobs-download", "title": "Download Streamlabs OBS" } }), _c("Button", { attrs: { "variation": "slobs-download-landing", "osType": "windows" } }), _c("Button", { attrs: { "variation": "slobs-download-landing", "osType": "mac" } })], 1)];
  }, proxy: true }]) })], 1)]), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Square Buttons")]), _c("p", [_vm._v("Used for add and subtract number inputs as well as login buttons.")]), _c("DemoSection", { attrs: { "title": "Square Buttons", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "type": "button", "size": "square", "variation": "default", "icon": "add" } }), _c("Button", { attrs: { "type": "button", "size": "square", "variation": "default", "icon": "subtract" } }), _c("Button", { attrs: { "type": "button", "variation": "facebook", "size": "square", "icon": "facebook" } }), _c("Button", { attrs: { "type": "button", "variation": "periscope", "size": "square", "icon": "periscope" } }), _c("Button", { attrs: { "type": "button", "variation": "mixer", "size": "square", "icon": "mixer" } }), _c("Button", { attrs: { "type": "button", "variation": "picarto", "size": "square", "icon": "picarto" } }), _c("Button", { attrs: { "type": "button", "variation": "ultra", "size": "square", "icon": "ultra" } })], 1)];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Navigation Buttons")]), _c("p", [_vm._v("Used to bring you between different page states.")]), _c("DemoSection", { attrs: { "title": "Navigation Buttons", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("Button", { attrs: { "variation": "navigation", "icon": "back-alt", "title": "Back to Listings" } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Prime Button Text")]), _c("p", [_vm._v("Used for prime button with text.")]), _c("DemoSection", { attrs: { "title": "Prime Button Text", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("div", { staticClass: "s-button-container s-button-container--left" }, [_c("Button", { attrs: { "variation": "prime-simple" } }), _c("Button", { attrs: { "variation": "prime-simple", "primeTitle": "test" } })], 1)];
  }, proxy: true }]) })], 1), _vm._m(1)]);
};
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Buttons")]), _c("p", [_vm._v(" Our button component is super flexible. It can act as type "), _c("code", [_vm._v("button")]), _vm._v(", "), _c("code", [_vm._v("a")]), _vm._v(" tag or "), _c("code", [_vm._v("router-link")]), _vm._v(". Please note that you may need to use 'ButtonInput' rather than 'Button' to avoid issues. ")]), _c("pre", [_c("code", [_vm._v("import { Button } from 'streamlabs-beaker';\n\ncomponents: {\n  Button\n}")])])]);
}, function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
