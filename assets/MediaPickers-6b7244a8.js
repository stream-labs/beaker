var M=Object.defineProperty;var g=(e,n,i)=>n in e?M(e,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[n]=i;var d=(e,n,i)=>(g(e,typeof n!="symbol"?n+"":n,i),i);import{W as u,C as h,P as m,V as f,n as _}from"./index-e8bb31bb.js";import{F as y}from"./FormGroup-8689511b.js";import{m as b}from"./vue-focus.common-5db36fb2.js";import{i as w}from"./ResizeObserver.es-0f9f8adb.js";import{B as C}from"./Button-3cf72d47.js";import{D as P}from"./DemoSection-b2dfe451.js";import"./Accordion-79d22a9d.js";var V=Object.defineProperty,S=Object.getOwnPropertyDescriptor,r=(e,n,i,t)=>{for(var o=t>1?void 0:t?S(n,i):n,a=e.length-1,l;a>=0;a--)(l=e[a])&&(o=(t?l(n,i,o):l(o))||o);return t&&o&&V(n,i,o),o};let s=class extends f{constructor(){super(...arguments);d(this,"$refs");d(this,"variation");d(this,"mediaLink");d(this,"mediaPreview");d(this,"title");d(this,"value");d(this,"controlsAlwaysVisible");d(this,"canDelete");d(this,"mediaPickerSmall",!1);d(this,"mediaBroken",!1);d(this,"mediaControlsVisible",!1);d(this,"focused",0)}get mediaControls(){return[{key:"media-link",available:!!this.mediaLink,class:"s-media-picker__link-icon",emit:"link-media",title:`Link ${this.variationTitle}`,icon:"icon-link"},{key:"media-selected-zoom",available:this.mediaPreview&&this.variation==="image"&&this.media.selected&&!this.mediaBroken,class:"s-media-picker__zoom-icon",emit:"preview-media",title:`Preview ${this.variationTitle}`,icon:"icon-zoom"},{key:"media-selected-play",available:this.mediaPreview&&!this.mediaBroken&&this.variation==="audio"&&this.media.selected,class:"s-media-picker__play-icon",emit:"preview-media",title:`preview ${this.variationTitle}`,icon:"icon-media-share-2"},{key:"media-remove",available:this.media.selected,class:"s-media-picker__small-remove",emit:"remove-media",title:`Remove ${this.variationTitle}`,icon:"icon-close"},{key:"media-select",available:!0,class:"s-media-picker__small-remove",emit:"select-media",title:`Select ${this.variationTitle}`,icon:"icon-upload-image"}].filter(t=>!(!t.available||!this.canDelete&&t.key==="media-remove"))}get mediaInputPlaceholder(){return this.variation==="audio"?"Select Audio File":"Select Image/Video File"}get buttonTitle(){return this.variation?`Select ${this.variation}`:"Select Media"}get variationTitle(){return this.variation==="image"?"Image":"Audio"}get media(){return{selected:!!this.value,fileName:this.value?this.value.split("/").pop():"",url:this.value}}get noMediaIcon(){return this.variation==="image"?"icon-image":"icon-music"}get valueIsVideo(){const i=this.value;if(!i)return!1;const t=[".mov",".wmv",".flv",".avi",".webm",".mkv",".mp4"],o=i.split("?")[0];return t.some(a=>o.endsWith(a))}watchValue(){this.setBrokenMedia(null)}watchMediaControlsVisible(){this.mediaPickerSmall&&!this.mediaControlsVisible&&(this.focused=-1)}watchMediaControls(i){this.focused=i.length-1}mounted(){new w((t,o)=>{for(const a of t){const{left:l,top:z,width:k,height:W}=a.contentRect;this.mediaPickerSmall=k<500}}).observe(this.$refs.mediaPicker),this.focused=this.mediaControls.length-1}setBrokenMedia(i){this.mediaBroken=!!i}onTabOut(){this.mediaPickerSmall&&(this.mediaControlsVisible=!1)}moveRight(){this.focused=Math.min(this.focused+1,this.mediaControls.length-1)}moveLeft(){this.focused=Math.max(this.focused-1,0)}showMediaControls(){this.mediaControlsVisible=!0,this.focused=this.mediaControls.length-1}handleControlVisibility(i){this.controlsAlwaysVisible||(this.mediaControlsVisible=i)}};r([m()],s.prototype,"variation",2);r([m({default:!1})],s.prototype,"mediaLink",2);r([m({default:!0})],s.prototype,"mediaPreview",2);r([m()],s.prototype,"title",2);r([m()],s.prototype,"value",2);r([m({default:!1})],s.prototype,"controlsAlwaysVisible",2);r([m({default:!0})],s.prototype,"canDelete",2);r([u("value")],s.prototype,"watchValue",1);r([u("mediaControlsVisible")],s.prototype,"watchMediaControlsVisible",1);r([u("mediaControls")],s.prototype,"watchMediaControls",1);s=r([h({components:{Button:C},mixins:[b]})],s);var x=function(){var e=this,n=e.$createElement,i=e._self._c||n;return i("div",{ref:"mediaPicker",staticClass:"s-media-picker"},[i("div",{staticClass:"s-media-picker__input-wrapper"},[i("div",{staticClass:"s-media-picker__thumb"},[i("transition",{attrs:{name:"fade",mode:"out-in"}},[e.media.selected?e._e():i("i",{key:"thumb-upload",staticClass:"s-media-picker__no-media",class:e.noMediaIcon}),e.media.selected&&e.variation==="audio"?i("i",{key:"thumb-audio",staticClass:"icon-music"},[i("audio",{key:"thumb-audio",attrs:{src:e.media.url},on:{error:e.setBrokenMedia}})]):e._e(),e.media.selected&&e.variation==="image"&&!e.valueIsVideo?i("img",{key:"thumb-image",attrs:{src:e.media.url},on:{error:e.setBrokenMedia}}):e._e(),e.media.selected&&e.variation==="image"&&e.valueIsVideo?i("i",{key:"thumb-video",staticClass:"icon-studio"}):e._e()]),i("transition",{attrs:{name:"custom-classes-transition","leave-active-class":"fade-slow-leave-active",mode:"out-in"}},[e.media.selected&&e.mediaBroken?i("div",{staticClass:"s-media-picker__broken-image"}):e._e()])],1),i("div",{staticClass:"s-media-picker__filename"},[i("transition",{attrs:{mode:"out-in",name:"fade"}},[e.value?i("div",{key:"media-selected",staticClass:"s-media-picker__text"},[e._v(" "+e._s(e.media.fileName)+" ")]):e._e(),e.value?e._e():i("div",{key:"media-not-selected",staticClass:"s-media-picker__text-placeholder"},[e._v(" "+e._s(e.title||e.mediaInputPlaceholder)+" ")])]),i("div",{staticClass:"s-media-picker__controls s-media-picker__controls--small",on:{mouseenter:function(t){return e.handleControlVisibility(!0)},mouseleave:function(t){return e.handleControlVisibility(!1)}}},[e.mediaPickerSmall&&!e.mediaControlsVisible&&!e.controlsAlwaysVisible?i("i",{directives:[{name:"focus",rawName:"v-focus",value:e.focused===-1,expression:"focused === -1"}],staticClass:"icon-add",attrs:{tabindex:e.mediaPickerSmall&&!e.mediaControlsVisible?0:-1},on:{focus:function(t){e.focused=-1},keydown:[function(t){return!t.type.indexOf("key")&&e._k(t.keyCode,"space",32,t.key,[" ","Spacebar"])?null:(t.preventDefault(),e.showMediaControls.apply(null,arguments))},function(t){return!t.type.indexOf("key")&&e._k(t.keyCode,"enter",13,t.key,"Enter")?null:(t.preventDefault(),e.showMediaControls.apply(null,arguments))}]}}):i("transition-group",{staticClass:"s-media-picker__controls-group",attrs:{tag:"div",mode:"out-in",name:"fade"}},e._l(e.mediaControls,function(t,o){return i("a",{directives:[{name:"focus",rawName:"v-focus",value:e.focused===o,expression:"focused === index"}],key:t.key,class:t.class,attrs:{title:t.title,tabindex:e.focused===o?0:-1},on:{focus:function(a){e.focused=o},click:function(a){return a.stopPropagation(),e.$emit(t.emit)},keydown:[function(a){return!a.type.indexOf("key")&&e._k(a.keyCode,"tab",9,a.key,"Tab")?null:e.onTabOut.apply(null,arguments)},function(a){return!a.type.indexOf("key")&&e._k(a.keyCode,"space",32,a.key,[" ","Spacebar"])?null:(a.preventDefault(),e.$emit(t.emit))},function(a){return!a.type.indexOf("key")&&e._k(a.keyCode,"enter",13,a.key,"Enter")?null:(a.preventDefault(),e.$emit(t.emit))},function(a){return!a.type.indexOf("key")&&e._k(a.keyCode,"left",37,a.key,["Left","ArrowLeft"])||"button"in a&&a.button!==0?null:(a.preventDefault(),e.moveLeft())},function(a){return!a.type.indexOf("key")&&e._k(a.keyCode,"right",39,a.key,["Right","ArrowRight"])||"button"in a&&a.button!==2?null:(a.preventDefault(),e.moveRight())}]}},[i("i",{class:t.icon})])}),0)],1)],1)])])},D=[];const v={};var A=_(s,x,D,!1,I,null,null,null);function I(e){for(let n in v)this[n]=v[n]}const O=function(){return A.exports}(),T=`<template>
  <div>
    <div class="section">
      <h1>Media Pickers</h1>
