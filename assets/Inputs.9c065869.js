var j=Object.defineProperty;var A=(e,a,t)=>a in e?j(e,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[a]=t;var o=(e,a,t)=>(A(e,typeof a!="symbol"?a+"":a,t),t);import{C as b,P as l,V as f,n as x,W as y}from"./index.17a864f5.js";import{C as G,R as B,S as $}from"./Selector.4adddbf7.js";import{D as M}from"./DemoSection.a0f0b33e.js";import{F}from"./FormGroup.87e771a1.js";import{i as q}from"./ResizeObserver.es.bd9ff68d.js";import{o as L,T as P}from"./TextInput.96a62e1b.js";import{B as E}from"./Button.5177b229.js";import{F as H}from"./fuse.esm.249bd5bb.js";import"./Accordion.a5b0018d.js";import"./_baseClone.a3c057f3.js";var z=Object.defineProperty,W=Object.getOwnPropertyDescriptor,_=(e,a,t,n)=>{for(var s=n>1?void 0:n?W(a,t):a,i=e.length-1,r;i>=0;i--)(r=e[i])&&(s=(n?r(a,t,s):r(s))||s);return n&&s&&z(a,t,s),s};let v=class extends f{constructor(){super(...arguments);o(this,"$refs");o(this,"value");o(this,"width");o(this,"height");o(this,"options");o(this,"containerWidth",0)}get selectedItemIndex(){return this.options.findIndex(a=>a.value===this.value)}get totalRows(){const a=this.options.length,t=(parseInt(this.width,10)||64)+8,n=a*t;return Math.ceil(n/this.containerWidth)}get itemsPerRow(){const a=(parseInt(this.width,10)||64)+8;return Math.floor(this.containerWidth/a)}get itemsInFinalRow(){return this.options.length%this.itemsPerRow}get itemPosMatrix(){let a=[],t=1,n=1,s=this.options.length,i=0;for(;i<s;)a.push([t,n]),n++,n>this.itemsPerRow&&(n=1,t++),i++;return a}mounted(){this.$nextTick(()=>{const a=document.querySelector(".s-image-picker-input");new q((n,s)=>{for(const i of n){const{left:r,top:je,width:D,height:Ae}=i.contentRect;this.containerWidth=D}}).observe(a),this.containerWidth=a.clientWidth})}emitInput(a){this.$emit("input",a)}setValueByKeyPress(a){let t=[...this.itemPosMatrix[this.selectedItemIndex]],n=this.selectedItemIndex;a==="UP"&&(t[0]<=1?t[0]=1:t[0]--),a==="DOWN"&&(t[0]>=this.totalRows?t[0]=this.totalRows:(t[0]++,t[1]>this.itemsInFinalRow&&(t[1]=this.itemsInFinalRow))),a==="LEFT"&&(t[0]<=1&&t[1]<=1?t[1]=1:t[0]>1&&t[1]===1?(t[0]--,t[1]=this.itemsPerRow):t[1]--),a==="RIGHT"&&(this.options.length<this.itemsPerRow&&t[1]>=this.options.length?t[1]=this.options.length:t[1]>=this.itemsInFinalRow&&t[0]===this.totalRows?t[1]=this.itemsInFinalRow:t[1]===this.itemsPerRow&&t[0]<this.totalRows?(t[0]++,t[1]=1):t[1]++),n=this.itemPosMatrix.findIndex(s=>s[0]===t[0]&&s[1]===t[1]),this.$refs.imagePickerItem[n].focus(),this.emitInput(this.options[n].value)}};_([l({default:"above"})],v.prototype,"value",2);_([l(String)],v.prototype,"width",2);_([l(String)],v.prototype,"height",2);_([l({default:()=>[{value:"above",title:"Above",image:"https://cdn.streamlabs.com/layouts/img/above.png"},{value:"banner",title:"Banner",image:"https://cdn.streamlabs.com/layouts/img/banner.png"},{value:"side",title:"Side",image:"https://cdn.streamlabs.com/layouts/img/side.png"}]})],v.prototype,"options",2);v=_([b({})],v);var N=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("div",{staticClass:"s-image-picker-input"},e._l(e.options,function(n){return t("div",{key:n.value,ref:"imagePickerItem",refInFor:!0,staticClass:"s-image-picker-input__option",class:[e.value===n.value?"active":""],style:{width:e.width,height:e.height},attrs:{value:n.value,title:n.title,image:n.image,tabindex:e.value===n.value?"0":"-1"},on:{click:function(s){return e.emitInput(n.value)},keydown:[function(s){return!s.type.indexOf("key")&&e._k(s.keyCode,"up",38,s.key,["Up","ArrowUp"])?null:(s.preventDefault(),e.setValueByKeyPress("UP"))},function(s){return!s.type.indexOf("key")&&e._k(s.keyCode,"down",40,s.key,["Down","ArrowDown"])?null:(s.preventDefault(),e.setValueByKeyPress("DOWN"))},function(s){return!s.type.indexOf("key")&&e._k(s.keyCode,"left",37,s.key,["Left","ArrowLeft"])||"button"in s&&s.button!==0?null:(s.preventDefault(),e.setValueByKeyPress("LEFT"))},function(s){return!s.type.indexOf("key")&&e._k(s.keyCode,"right",39,s.key,["Right","ArrowRight"])||"button"in s&&s.button!==2?null:(s.preventDefault(),e.setValueByKeyPress("RIGHT"))}]}},[t("img",{attrs:{src:n.image}})])}),0)},U=[];const k={};var Q=x(v,N,U,!1,Y,null,null,null);function Y(e){for(let a in k)this[a]=k[a]}const K=function(){return Q.exports}(),X=`<template>
  <div>
    <h1>Inputs</h1>
