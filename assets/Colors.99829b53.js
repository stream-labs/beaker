...
let Colors$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
const Colors_vue_vue_type_style_index_0_scoped_9a5226ff_lang = "";
var _sfc_render = function render() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "s-colors" }, [_vm._m(0), _vm._l(_vm.colors, function(colorGroup, index) {
    return _c("div", { key: `color-group-${index}`, staticClass: "section" }, _vm._l(colorGroup, function(color) {
      return _c("div", { key: color.color, staticClass: "side-by-side" }, [_c("div", { staticClass: "nospace-flex" }, [_c("div", { staticClass: "color-square", style: "background-color:" + color.hex + ";" }), _c("div", { staticClass: "subtitle" }, [_vm._v(" " + _vm._s(color.color) + " ")])]), _c("div", [_c("span", { directives: [{ name: "clipboard", rawName: "v-clipboard:copy", value: color.name, expression: "color.name", arg: "copy" }, { name: "clipboard", rawName: "v-clipboard:success", value: _vm.emitCopySuccess, expression: "emitCopySuccess", arg: "success" }, { name: "clipboard", rawName: "v-clipboard:error", value: _vm.emitCopyError, expression: "emitCopyError", arg: "error" }], staticClass: "name color-code" }, [_vm._v(_vm._s(color.name))]), _c("span", { directives: [{ name: "clipboard", rawName: "v-clipboard:copy", value: color.hex, expression: "color.hex", arg: "copy" }, { name: "clipboard", rawName: "v-clipboard:success", value: _vm.emitCopySuccess, expression: "emitCopySuccess", arg: "success" }, { name: "clipboard", rawName: "v-clipboard:error", value: _vm.emitCopyError, expression: "emitCopyError", arg: "error" }], staticClass: "hex color-code" }, [_vm._v(_vm._s(color.hex))])])]);
    }), 0);
  })], 2);
};
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Colors")]), _c("p", [_vm._v(" Colors used on Streamlabs platforms. Click on a color to copy its variable code to the clipboard. ")])]);
}];
...
const Colors = __component__.exports;
export {
  Colors as default
};
//# sourceMappingURL=Colors.99829b53.js.map
