...
import { C as Component, P as Prop, V as Vue, n as normalizeComponent, W as Watch } from "./index.4fb8a6cb.js";
...
let BannerDiscord$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$5 = function render() {
  ...
  return _c("div", { staticClass: "s-banner-discord" }, [_c("h2", { staticClass: "s-banner-discord__title", domProps: { "innerHTML": _vm._s(_vm.title) } }), _c("Button", _vm._g({ attrs: { "title": "Open Discord", "icon": "discord", "iconPosition": "right", "variation": "custom", "bgColor": "#FFFFFF", "textColor": "#7289DA", "tag": "a", "href": "https://discord.gg/stream", "target": "_blank" } }, _vm.$listeners))], 1);
};
...
const BannerDiscord = __component__$5.exports;
...
let BannerIntroduction$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$4 = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "s-banner-introduction", style: { "background-color": _vm.bgColor } }, [_vm._t("bgImage"), _c("div", { staticClass: "s-banner-introduction__body" }, [_c("h2", { staticClass: "s-banner-introduction__title" }, [_vm._t("title")], 2), _c("p", { staticClass: "s-banner-introduction__description" }, [_vm._t("description")], 2)]), _c("div", { staticClass: "s-banner-introduction__button" }, [_vm._t("button")], 2)], 2);
};
...
const BannerIntroduction = __component__$4.exports;
...
let BannerMarketing$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$3 = function render3() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { ref: "banner", staticClass: "s-banner" }, [_c("div", { staticClass: "s-banner__bg", style: {
  ...
  } }), _c("div", { staticClass: "s-banner__bg s-banner__bg--night", style: {
  ...
  } }), _c("div", { key: "banner-open", staticClass: "s-banner__body", class: { "s-banner__body--closed": _vm.closed } }, [_c("div", { staticClass: "s-banner__wrapper" }, [_c("div", { staticClass: "s-banner__label" }, [_vm._v(_vm._s(_vm.label))]), _c("i", { staticClass: "icon-down", attrs: { "tabindex": "0" }, on: { "click": function($event) {
    ...
    return _vm.toggleBanner();
  } } })]), _c("div", { ref: "bottomWrapper", staticClass: "s-banner__wrapper" }, [_c("div", { staticClass: "s-banner__title" }, [_vm.iconName ? _c("div", { staticClass: "s-banner__icon" }, [_c("i", { class: `icon-${_vm.iconName}` })]) : _vm._e(), _vm.iconImage ? _c("div", { staticClass: "s-banner__icon" }, [_c("img", { attrs: { "src": _vm.iconImage } })]) : _vm._e(), _c("div", { staticClass: "s-banner__details" }, [_c("h2", { staticClass: "s-banner__name" }, [_vm._v(_vm._s(_vm.title))]), _c("p", { staticClass: "s-banner__desc" }, [_vm._v(_vm._s(_vm.desc))])])]), _c("div", { staticClass: "s-banner__download-wrapper", on: { "click": function($event) {
    $event.stopPropagation();
  } } }, [_vm._t("link"), _c("i", { staticClass: "icon-down", attrs: { "tabindex": "0" }, on: { "click": function($event) {
    return _vm.toggleBanner();
  }, "keydown": function($event) {
    if (!$event.type.indexOf("key") && _vm._k($event.keyCode, "space", 32, $event.key, [" ", "Spacebar"]))
      return null;
    $event.preventDefault();
    return _vm.toggleBanner();
  } } }), _c("div", { staticClass: "s-banner__link-desc" }, [_vm._v(_vm._s(_vm.linkDesc))])], 2)])])]);
};
...
const BannerMarketing = __component__$3.exports;
...
let BannerSale$1 = class extends Vue {
  constructor() {
    super(...arguments);
    __publicField(this, "title");
    __publicField(this, "desc");
...
var _sfc_render$2 = function render4() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "s-banner-sale", style: {
    "background-color": _vm.backgroundColor,
    "border-color": _vm.borderColor
  } }, [_c("div", { staticClass: "s-banner-sale__wrapper s-header" }, [_c("h1", [_vm._v(_vm._s(_vm.title))]), _c("p", [_vm._v(_vm._s(_vm.desc))])]), _c("div", { staticClass: "s-banner-sale__wrapper s-header" }, [_c("h1", { staticClass: "s-banner-sale__time" }, [_c("span", { class: { "s-banner-sale__time--done": _vm.daysDone } }, [_vm._v(_vm._s(`${_vm.days}d`))]), _c("span", { class: { "s-banner-sale__time--done": _vm.hoursDone } }, [_vm._v(_vm._s(`${_vm.hours}h`))]), _c("span", { class: { "s-banner-sale__time--done": _vm.minutesDone } }, [_vm._v(_vm._s(`${_vm.minutes}m`))]), _c("span", { class: { "s-banner-sale__time--done": _vm.secondsDone } }, [_vm._v(_vm._s(`${_vm.seconds}s`))])]), _c("p", [_vm._v(_vm._s(_vm.timeDesc))])])]);
};
...
const BannerSale = __component__$2.exports;
...
let Notice$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$1 = function render5() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "s-notice", class: `s-notice--${_vm.iconType}` }, [_c("div", { staticClass: "s-notice__wrapper" }, [_c("i", { staticClass: "s-notice__icon-bg", class: [_vm.iconClass] }), _c("div", { staticClass: "s-notice__body" }, [_c("i", { staticClass: "s-notice__icon", class: [_vm.iconClass] }), _c("div", { staticClass: "s-notice__detail" }, [_c("h2", { staticClass: "s-notice__title" }, [_vm._v(_vm._s(_vm.title))]), _c("p", { staticClass: "s-notice__desc" }, [_vm._v(_vm._s(_vm.desc))])])]), _c("div", { staticClass: "s-notice__button" }, [_vm._t("button")], 2)])]);
};
...
const Notice = __component__$1.exports;
...
let Banners$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
const Banners_vue_vue_type_style_index_0_scoped_52af370b_lang = "";
var _sfc_render = function render6() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_c("h1", [_vm._v("Banners")]), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Marketing Banner")]), _c("DemoSection", { attrs: { "title": "Marketing Banner", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("banner-marketing", { attrs: { "bg-image": "\n              https://cdn.streamlabs.com/static/imgs/pretzel_dashboard_banner_bg.png\n            ", "bg-image-night": "\n              http://cdn.backgroundhost.com/backgrounds/subtlepatterns/cartographer.png\n            ", "icon-name": "themes", "label": "Introducing Streamlabs OBS", "title": "Largest library of free themes in the world.", "desc": "\n              To access over 700+ themes for free, download Streamlabs OBS.\n            ", "link-desc": "Win 7+  245.8 MB", "onToggle": _vm.test } }, [_c("Button", { attrs: { "slot": "link", "type": "a", "variation": "action", "size": "standard", "href": "#", "title": "Download", "icon": "overview" }, slot: "link" })], 1)];
  }, proxy: true }]) }), _c("banner-marketing", { attrs: { "bg-image": "\n          https://cdn.streamlabs.com/static/imgs/pretzel_dashboard_banner_bg.png\n        ", "icon-image": _vm.pretzelIcon, "label": "New Streamlabs OBS App", "title": "Introducing Pretzel Rocks Music Player", "desc": "\n          Stream-safe music for broadcasters with an ever-growing catalog of music. Currently 5k+ tracks.\n        ", "link-desc": "$4.99/mo", "banner-closed": _vm.bannerClosed } }, [_c("Button", { attrs: { "slot": "link", "type": "a", "variation": "action", "size": "standard", "href": "#", "title": "Try It Now" }, slot: "link" })], 1), _vm._m(0)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Sale Banner")]), _c("DemoSection", { attrs: { "title": "Sale Banner", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("banner-sale", { attrs: { "title": "Flash Sale! 25% off everything!", "desc": "All items are automatically discounted.", "days": "00", "hours": "00", "minutes": "00", "seconds": _vm.secs, "time-desc": "Until flash sale ends. Hurry!" } })];
  }, proxy: true }]) }), _vm._m(1)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Notice Banner")]), _c("DemoSection", { attrs: { "title": "Notice Banner", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("Notice", { attrs: { "title": "\n              Join affiliates and earn $1 for each Streamlabs OBS referral\n            ", "desc": "\n              Share your unique referral link with friends and get paid directly into your PayPal each month.\n            ", "icon": "information" } }, [_c("Button", { attrs: { "slot": "button", "type": "button", "size": "fixed-width", "variation": "action", "title": "Join" }, slot: "button" })], 1)];
  }, proxy: true }]) }), _c("br"), _c("br"), _c("Notice", { attrs: { "variation": "warning", "title": "Your donation link has expired", "desc": "Copy your new donation link and replace all instances containing twitchalerts.com." } }, [_c("Button", { attrs: { "slot": "button", "type": "button", "size": "fixed-width", "variation": "default", "title": "Copy Link" }, slot: "button" })], 1), _vm._m(2)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Discord Banner")]), _c("DemoSection", { attrs: { "title": "Discord Banner", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("BannerDiscord")];
  }, proxy: true }]) }), _vm._m(3)], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Introduction Banner")]), _c("DemoSection", { attrs: { "title": "Introduction Banner", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("BannerIntroduction", { attrs: { "bgColor": "#5e3bec" }, scopedSlots: _vm._u([{ key: "title", fn: function() {
      return [_vm._v("Introducing"), _c("span", { staticClass: "banner-introduction-title" }, [_vm._v("Prime Alert Box Sounds")])];
...
var _sfc_staticRenderFns = [function() {
  ...
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("table", { staticClass: "docs-table" }, [_c("thead", [_c("tr", [_c("th", [_vm._v("Prop")]), _c("th", [_vm._v("Type")]), _c("th", [_vm._v("Default")]), _c("th", [_vm._v("Description")])])]), _c("tbody", [_c("tr", [_c("td", [_vm._v("bgColor")]), _c("td", [_vm._v("string")]), _c("td", [_vm._v("Null")]), _c("td", [_vm._v("Set the background color of the banner.")])])])]);
}];
...
const Banners = __component__.exports;
export {
  Banners as default
};
