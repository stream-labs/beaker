...
let EmptySections$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render = function render() {
  ...
  return _c("div", [_vm._m(0), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Search Variation")]), _c("DemoSection", { attrs: { "title": "Search Variation", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("EmptySection", { attrs: { "variation": "search", "title": "No results found for 'sadasdasd'", "subtitle": "Try another search term." } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Text Variation")]), _c("DemoSection", { attrs: { "title": "Text Variation", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("EmptySection", { attrs: { "title": "You don't have any pending users yet", "subtitle": "Open a queue to get started." } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Warning Variation")]), _c("DemoSection", { attrs: { "title": "Warning Variation", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("EmptySection", { attrs: { "variation": "warning", "title": "You need to setup your domain", "subtitle": "A domain name is required for custom email." } })];
  }, proxy: true }]) })], 1), _vm._m(1)]);
};
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Empty Sections")]), _c("pre", [_c("code", [_vm._v("import { EmptySection } from 'streamlabs-beaker';\n\ncomponents: {\n  EmptySection\n}")])])]);
}, function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
...
const EmptySections = __component__.exports;
export {
  EmptySections as default
};
