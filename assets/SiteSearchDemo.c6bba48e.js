...
let SiteSearch$1 = class extends Vue {
  constructor() {
    super(...arguments);
    ...
    __publicField(this, "quickLinkLoc", []);
  ...
  get suggestedLinks() {
    return this.quickLinks.filter((i) => {
      let findResult = this.searchData.find(
        (data2) => data2.name === i.item.name
      );
      let suggestResult = this.searchData.indexOf(findResult);
  ...
  keyEvent(event) {
    ...
    if (event.keyCode === 13 && this.phaseOne) {
      if (this.result <= 0) {
        ...
        window.location.href = this.searchData[this.quickLinkLoc[this.currentResult]].route;
        this.blurSearch();
      } else {
        this.trackEvent(this.currentResult);
...
__decorateClass$1([
  Watch("searchData")
], SiteSearch$1.prototype, "watchSearchData", 1);
__decorateClass$1([
  Watch("search")
...
var _sfc_render$1 = function render() {
  ...
  return _c("div", { staticClass: "s-sitesearch", class: [
    { "s-sitesearch--is-open": _vm.isOpen },
    { "s-sitesearch--phase-one": _vm.phaseOne },
    { "s-sitesearch--phase-two": _vm.phaseTwo }
  ], style: _vm.calcHeight }, [_c("div", { staticClass: "s-sitesearch--searchbar__cont" }, [_vm._m(0), _c("input", { directives: [{ name: "model", rawName: "v-model", value: _vm.value, expression: "value" }], ref: "search_input", staticClass: "s-sitesearch__input", attrs: { "type": "text", "placeholder": "Search Streamlabs..." }, domProps: { "value": _vm.value }, on: { "focus": function($event) {
  ...
  } } })]), _c("transition-group", { attrs: { "name": "s-sitesearch--fadeY" } }, [_vm.phaseTwo && _vm.limitedResult.length <= 0 ? _c("div", { key: _vm.limitedResult.length, staticClass: "s-sitesearch-results__cont" }, [_c("div", { staticClass: "s-sitesearch-quicklinks" }, [_vm._v("Quick Links")]), _vm._l(_vm.suggestedLinks, function(suggested, i) {
    return _c("a", { key: suggested.item.name, staticClass: "s-sitesearch-results", class: { "s-active-result": _vm.currentResult === i }, attrs: { "href": _vm.searchData[_vm.quickLinkLoc[i]].route }, on: { "mouseover": function($event) {
      _vm.currentResult = i;
    }, "mousedown": function($event) {
      return _vm.trackEvent(_vm.searchData[_vm.quickLinkLoc[i]].route);
    }, "mouseup": _vm.blurSearch } }, [_c("div", { staticClass: "s-sitesearch__result--image" }, [_c("i", { staticClass: "s-sitesearch__result--image", class: _vm.searchData[_vm.quickLinkLoc[i]].image })]), _c("div", { staticClass: "s-sitesearch__result--title" }, [_vm._v(" " + _vm._s(_vm.searchData[_vm.quickLinkLoc[i]].title) + " ")])]);
  })], 2) : _vm._e(), _vm.phaseTwo && _vm.limitedResult.length >= 1 ? _c("div", { key: _vm.limitedResult.length, staticClass: "s-sitesearch-results__cont" }, [_c("transition-group", { attrs: { "name": "s-sitesearch--fadeX" } }, _vm._l(_vm.limitedResult, function(searchResult, i) {
    return _c("a", { key: searchResult.item.name, staticClass: "s-sitesearch-results", class: { "s-active-result": _vm.currentResult === i }, attrs: { "href": searchResult.item.route }, on: { "mouseover": function($event) {
      _vm.currentResult = i;
    }, "mousedown": function($event) {
      return _vm.trackEvent(_vm.searchData[_vm.quickLinkLoc[i]].route);
    }, "mouseup": _vm.blurSearch } }, [_c("div", { staticClass: "s-sitesearch__result--image" }, [_c("i", { staticClass: "s-sitesearch__result--image", class: searchResult.item.image })]), _c("div", { staticClass: "s-sitesearch__result--title" }, [_vm._v(" " + _vm._s(searchResult.item.title) + " ")])]);
  }), 0)], 1) : _vm._e()])], 1);
};
var _sfc_staticRenderFns$1 = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "s-sitesearch--icon" }, [_c("i", { staticClass: "icon-search" })]);
}];
...
const SiteSearch = __component__$1.exports;
...
let SiteSearchDemo$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Site Search")]), _c("p", [_vm._v(" This site search is live on core. It can be used with other json files, JSON structure example below. ")]), _vm._m(0), _c("Accordion", { attrs: { "title": "JSON Site Search Structure" } }, [_c("div", { attrs: { "slot": "content" }, slot: "content" }, [_c("p", [_c("code", [_vm._v("keymatches")]), _vm._v(" and "), _c("code", [_vm._v("howto")]), _vm._v(" are not used right now, but will be used in the future. ")]), _c("div", { staticClass: "section" }, [_c("pre", [_c("code", [_vm._v('{\n  "data": [\n    {\n      "name": "contact",\n      "title": "Contact Us",\n      "route": "/contact",\n      "keywords": [\n        "contact",\n        "business",\n        "inquiries",\n        "social",\n        "media"\n      ],\n      "image": "icon-phone-case"\n    },\n  ]\n}')])])]), _c("p", [_vm._v("The JSON data and component can be imported normally")]), _c("pre", [_c("code", [_vm._v('import * as searchData from "./../location";\n\nexport default {\n  data() {\n    return {\n      jsonSearch = searchData.data\n    };\n  }\n}')])])])])], 1), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Seach Demo")]), _c("DemoSection", { attrs: { "title": "Default", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("SiteSearch", { attrs: { "json-search": _vm.jsonSearch, "quick-links": [
      { item: { name: "donationsettings" } },
      { item: { name: "d-alertbox" } },
      { item: { name: "creatorsites" } },
      { item: { name: "merchsetup" } },
...
const SiteSearchDemo = __component__.exports;
export {
  SiteSearchDemo as default
};
