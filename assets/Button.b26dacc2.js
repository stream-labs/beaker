...
let Button$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render = function render() {
  ...
  return _c(_vm.tag, { tag: "component", staticClass: "s-button ripple", class: [_vm.buttonClasses, { "ripple-animate": _vm.rippleAnimate }], style: _vm.buttonStyle, attrs: { "icon": _vm.icon, "icon-img": _vm.iconImg, "title": _vm.title, "price": _vm.price, "description": _vm.description, "to": _vm.to, "href": _vm.href, "type": _vm.type, "disabled": _vm.state === "disabled" || _vm.state === "loading", "target": _vm.target }, on: { "click": function($event) {
    return _vm.$emit("click");
  }, "mousedown": _vm.pressDown } }, [!_vm.$slots.custom ? _c("span", [_c("span", [_vm.variation === "prime-simple" && this.primeTitle ? _c("span", [_vm._v(" " + _vm._s(_vm.primeTitle) + " ")]) : _vm.variation === "prime-simple" ? _c("span", { staticClass: "prime-simple" }, [_vm._v(" Free with "), _c("span", { staticClass: "prime-simple__bold" }, [_vm._v(" Prime")])]) : _vm._e(), _vm.iconClass && _vm.iconPosition === "left" ? _c("i", { class: _vm.iconClass }) : _vm._e(), _vm.iconImg ? _c("i", { staticClass: "icon-img" }, [_c("img", { attrs: { "src": _vm.iconImg, "alt": `${_vm.title} Icon Image` } })]) : _vm._e(), _vm._v(" " + _vm._s(_vm.title) + " ")]), _vm.description ? _c("span", { staticClass: "s-button__description" }, [_vm._v(" " + _vm._s(_vm.description) + " ")]) : _vm._e(), _vm.iconClass && _vm.iconPosition === "right" ? _c("i", { class: ["icon--right", _vm.iconClass] }) : _vm._e()]) : _vm._e(), _vm._t("custom"), _vm.variation === "slobs-download" ? _c("i", { staticClass: "icon-windows" }) : _vm._e(), _vm.price ? _c("span", [_vm._v(_vm._s(_vm.price))]) : _vm._e(), _vm.variation === "slobs-download-landing" ? _c("div", { staticClass: "slobs-download-landing" }, [_c("div", { staticClass: "slobs-download-landing__upper" }, [_c("i", { staticClass: "slobs-download-landing__icon", class: _vm.slobsDownloadIconClass }), _c("p", { staticClass: "slobs-download-landing__title" }, [_vm._v(_vm._s(_vm.slobsDownloadTitle))])]), _c("div", { staticClass: "slobs-download-landing__bottom" }, [_c("p", { staticClass: "slobs-download-landing__subtitle" }, [_vm._t("subtitle", function() {
    return _vm._l(_vm.slobsDownloadText, function(text) {
      return _c("span", { key: text, domProps: { "textContent": _vm._s(text) } });
    });
  })], 2)])]) : _vm._e()], 2);
};
...
//# sourceMappingURL=Button.b26dacc2.js.map
