...
let MediaPicker$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$1 = function render() {
  ...
  return _c("div", { ref: "mediaPicker", staticClass: "s-media-picker" }, [_c("div", { staticClass: "s-media-picker__input-wrapper" }, [_c("div", { staticClass: "s-media-picker__thumb" }, [_c("transition", { attrs: { "name": "fade", "mode": "out-in" } }, [!_vm.media.selected ? _c("i", { key: "thumb-upload", staticClass: "s-media-picker__no-media", class: _vm.noMediaIcon }) : _vm._e(), _vm.media.selected && _vm.variation === "audio" ? _c("i", { key: "thumb-audio", staticClass: "icon-music" }, [_c("audio", { key: "thumb-audio", attrs: { "src": _vm.media.url }, on: { "error": _vm.setBrokenMedia } })]) : _vm._e(), _vm.media.selected && _vm.variation === "image" && !_vm.valueIsVideo ? _c("img", { key: "thumb-image", attrs: { "src": _vm.media.url }, on: { "error": _vm.setBrokenMedia } }) : _vm._e(), _vm.media.selected && _vm.variation === "image" && _vm.valueIsVideo ? _c("i", { key: "thumb-video", staticClass: "icon-studio" }) : _vm._e()]), _c("transition", { attrs: { "name": "custom-classes-transition", "leave-active-class": "fade-slow-leave-active", "mode": "out-in" } }, [_vm.media.selected && _vm.mediaBroken ? _c("div", { staticClass: "s-media-picker__broken-image" }) : _vm._e()])], 1), _c("div", { staticClass: "s-media-picker__filename" }, [_c("transition", { attrs: { "mode": "out-in", "name": "fade" } }, [_vm.value ? _c("div", { key: "media-selected", staticClass: "s-media-picker__text" }, [_vm._v(" " + _vm._s(_vm.media.fileName) + " ")]) : _vm._e(), !_vm.value ? _c("div", { key: "media-not-selected", staticClass: "s-media-picker__text-placeholder" }, [_vm._v(" " + _vm._s(_vm.title || _vm.mediaInputPlaceholder) + " ")]) : _vm._e()]), _c("div", { staticClass: "s-media-picker__controls s-media-picker__controls--small", on: { "mouseenter": function($event) {
    return _vm.handleControlVisibility(true);
  }, "mouseleave": function($event) {
    return _vm.handleControlVisibility(false);
  } } }, [_vm.mediaPickerSmall && !_vm.mediaControlsVisible && !_vm.controlsAlwaysVisible ? _c("i", { directives: [{ name: "focus", rawName: "v-focus", value: _vm.focused === -1, expression: "focused === -1" }], staticClass: "icon-add", attrs: { "tabindex": _vm.mediaPickerSmall && !_vm.mediaControlsVisible ? 0 : -1 }, on: { "focus": function($event) {
    _vm.focused = -1;
    ...
    $event.preventDefault();
    return _vm.showMediaControls.apply(null, arguments);
  }] } }) : _c("transition-group", { staticClass: "s-media-picker__controls-group", attrs: { "tag": "div", "mode": "out-in", "name": "fade" } }, _vm._l(_vm.mediaControls, function(control, index2) {
    return _c("a", { directives: [{ name: "focus", rawName: "v-focus", value: _vm.focused === index2, expression: "focused === index" }], key: control.key, class: control.class, attrs: { "title": control.title, "tabindex": _vm.focused === index2 ? 0 : -1 }, on: { "focus": function($event) {
      _vm.focused = index2;
...
const MediaPicker = __component__$1.exports;
...
var _sfc_render = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_vm._m(0), _c("div", { staticClass: "section" }, [_c("DemoSection", { attrs: { "title": "Default", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("FormGroup", [_c("media-picker", { attrs: { "slot": "input", "variation": "image", "media-link": true, "media-preview": false, "title": "Select Video Media" }, on: { "select-media": _vm.selectVideoMedia, "preview-media": _vm.previewVideoMedia, "remove-media": _vm.removeVideoMedia }, slot: "input", model: { value: _vm.videoMedia, callback: function($$v) {
      _vm.videoMedia = $$v;
    }, expression: "videoMedia" } }), _c("media-picker", { attrs: { "slot": "input", "variation": "image", "media-link": true, "media-preview": false, "title": "Select Image Media" }, on: { "select-media": _vm.selectImageMedia, "preview-media": _vm.previewImageMedia, "remove-media": _vm.removeImageMedia }, slot: "input", model: { value: _vm.imageMedia, callback: function($$v) {
      _vm.imageMedia = $$v;
    }, expression: "imageMedia" } }), _c("media-picker", { attrs: { "slot": "input", "variation": "audio", "media-link": true }, on: { "select-media": _vm.selectAudioMedia, "remove-media": _vm.removeAudioMedia }, slot: "input", model: { value: _vm.audioMedia, callback: function($$v) {
      _vm.audioMedia = $$v;
    }, expression: "audioMedia" } }), _c("media-picker", { attrs: { "slot": "input", "variation": "audio", "title": "My Sample Title", "media-link": true, "controls-always-visible": true }, on: { "select-media": _vm.selectAudioMedia, "remove-media": _vm.removeAudioMedia }, slot: "input", model: { value: _vm.audioMedia, callback: function($$v) {
      _vm.audioMedia = $$v;
    }, expression: "audioMedia" } })], 1)];
  }, proxy: true }]) })], 1), _vm._m(1)]);
};
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Media Pickers")]), _c("pre", [_c("code", [_vm._v("import { MediaPicker } from 'streamlabs-beaker';\n\ncomponents: {\n  MediaPicker\n}")])])]);
}, function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("table", { staticClass: "docs-table" }, [_c("thead", [_c("tr", [_c("th", [_vm._v("Props")]), _c("th", [_vm._v("Type")]), _c("th", [_vm._v("Default")]), _c("th", [_vm._v("Description")])])]), _c("tbody", [_c("tr", [_c("td", [_vm._v("variation")]), _c("td", [_vm._v("string")]), _c("td", [_vm._v("null")]), _c("td", [_vm._v(" Available variations include `image` and `audio`. Video is under the `image` variation. ")])]), _c("tr", [_c("td", [_vm._v("title")]), _c("td", [_vm._v("string")]), _c("td", [_vm._v("null")]), _c("td", [_vm._v("Customizable button text")])]), _c("tr", [_c("td", [_vm._v("mediaLink")]), _c("td", [_vm._v("boolean")]), _c("td", [_vm._v("false")]), _c("td", [_vm._v(" Will display a clickable link icon that emits `link-media` event. Primarily used on SL core to add a link to a media href. ")])]), _c("tr", [_c("td", [_vm._v("value")]), _c("td", [_vm._v("string")]), _c("td", [_vm._v("null")]), _c("td", [_vm._v("A URL string to the selected media.")])]), _c("tr", [_c("td", [_vm._v("controlsAlwaysVisible")]), _c("td", [_vm._v("boolean")]), _c("td", [_vm._v("false")]), _c("td", [_vm._v("Use if controls always need to be shown.")])]), _c("tr", [_c("td", [_vm._v("link-media")]), _c("td", [_vm._v("event")]), _c("td", [_vm._v("null")]), _c("td", [_vm._v("Event emitted when the link icon is clicked")])]), _c("tr", [_c("td", [_vm._v("preview-media")]), _c("td", [_vm._v("event")]), _c("td", [_vm._v("null")]), _c("td", [_vm._v(" Event emitted when the magnifiy glass or play icons are clicked ")])]), _c("tr", [_c("td", [_vm._v("remove-media")]), _c("td", [_vm._v("event")]), _c("td", [_vm._v("null")]), _c("td", [_vm._v(" Event emitted when the close icon or 'Remove' button is clicked ")])]), _c("tr", [_c("td", [_vm._v("select-media")]), _c("td", [_vm._v("event")]), _c("td", [_vm._v("null")]), _c("td", [_vm._v(" Event emitted when the plus icon or 'Select Media' button is clicked ")])])])])]);
}];
...
const MediaPickers = __component__.exports;
export {
