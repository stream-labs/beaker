...
import { a as commonjsGlobal, g as getDefaultExportFromCjs, C as Component, P as Prop, V as Vue, n as normalizeComponent } from "./index.4fb8a6cb.js";
...
const VuePaginateComponent = /* @__PURE__ */ getDefaultExportFromCjs(dist.exports);
...
let Pagination$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render$1 = function render() {
  ...
  return _c("div", { ref: "pagination", staticClass: "pagination__container" }, [_c("vue-paginate-component", _vm._g(_vm._b({ class: { "pagination--bg": _vm.nightBg }, attrs: { "page-count": _vm.pageCount, "page-range": _vm.pageRange, "click-handler": _vm.selectPage, "prev-text": "Prev", "next-text": "Next", "container-class": "s-pagination", "page-class": "s-pagination__page", "page-link-class": "s-pagination__page-link", "prev-class": "s-pagination__prev", "prev-link-class": "s-pagination__prev-link", "next-class": "s-pagination__next", "next-link-class": "s-pagination__next-link", "break-view-class": "s-pagination__break", "break-view-link-class": "s-pagination__break-link", "active-class": "s-pagination__active", "disabled-class": "s-pagination__disabled" } }, "vue-paginate-component", _vm.$attrs, false), _vm.$listeners))], 1);
};
...
const Pagination = __component__$1.exports;
...
let Paginations$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_vm._m(0), _c("div", { staticClass: "section" }, [_c("DemoSection", { attrs: { "title": "Pagination", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("Pagination", { attrs: { "night-bg": true, "items-per-page": 4, "total-item-count": 2010 }, on: { "page-selected": _vm.consolePage } })];
  }, proxy: true }]) })], 1), _vm._m(1)]);
};
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Pagination")]), _c("p", [_vm._v(" You can pass how many items you would like per page and total items for a dynamic page count or manually enter how many pages you want. ")]), _c("pre", [_c("code", [_vm._v('import { Pagination } from "streamlabs-beaker"\n\n@Component({\n  components: {\n    Pagination\n  }\n})')])])]);
}, function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
...
const Paginations = __component__.exports;
export {
