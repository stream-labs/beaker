...
import { a as commonjsGlobal, C as Component, P as Prop, V as Vue, n as normalizeComponent } from "./index.4fb8a6cb.js";
...
(function(module, exports) {
  !function(e, t) {
    ...
    return function(e) {
      ...
      })("versions", []).push({ version: r.version, mode: n(14) ? "pure" : "global", copyright: "\xA9 2019 Denis Pushkarev (zloirock.ru)" });
    }, function(e, t) {
...
let ColorPicker$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
ColorPicker$1 = __decorateClass$1([
  Component({
    inheritAttrs: false,
    components: {
      picker: vueColor_min.exports.Chrome
    }
  })
], ColorPicker$1);
...
var _sfc_render$1 = function render() {
  ...
  return _c("div", { ref: "colorpicker", staticClass: "s-colorpicker-container", class: {
    "s-colorpicker-container__mini": _vm.isMini,
    "s-colorpicker-container__mini-icon": _vm.isMini && _vm.icon
  } }, [!_vm.isMini ? _c("input", { class: { "s-colorpicker__input--error": _vm.error }, attrs: { "type": "text", "placeholder": _vm.placeholder }, domProps: { "value": _vm.value }, on: { "click": function($event) {
    return _vm.showPicker();
  }, "input": _vm.updateFromInput } }) : _vm._e(), _vm.isMini ? _c("div", { staticClass: "s-colorpicker__mini-wrapper", class: { "s-colorpicker__input--error": _vm.error }, on: { "click": function($event) {
    return _vm.showPicker();
  } } }, [_c("i", { class: _vm.icon })]) : _vm._e(), _vm.error ? _c("div", { staticClass: "s-colorpicker__input-error" }, [_c("i", { staticClass: "icon-error" }), _vm._v(" " + _vm._s(_vm.error) + " ")]) : _vm._e(), _c("div", { staticClass: "s-colorpicker__preview", style: { backgroundColor: _vm.value }, on: { "click": function($event) {
    return _vm.showPicker();
  } } }), _c("div", { staticClass: "s-colorpicker__preview--alpha" }), _c("transition", { attrs: { "name": "fade" } }, [_vm.displayPicker ? _c("div", { staticClass: "s-colorpicker__picker-wrapper" }, [_c("picker", { ref: "chrome-color-picker", staticClass: "s-colorpicker", class: _vm.alphaClass, attrs: { "value": _vm.colors, "disable-alpha": !_vm.hasAlpha, "disable-fields": !_vm.hasAlpha }, on: { "input": _vm.updateFromPicker } }), _vm.isMini ? _c("input", _vm._g({ staticClass: "s-colorpicker__input--mini", class: { "s-colorpicker__input--error": _vm.error }, attrs: { "type": "text", "placeholder": _vm.placeholder }, domProps: { "value": _vm.value }, on: { "input": _vm.updateFromInput } }, _vm.listeners)) : _vm._e()], 1) : _vm._e()])], 1);
};
...
const ColorPicker = __component__$1.exports;
...
let ColorPickers$1 = class extends Vue {
  constructor() {
    super(...arguments);
...
var _sfc_render = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", [_vm._m(0), _c("div", { staticClass: "section" }, [_c("h2", [_vm._v("Default Color Picker")]), _c("div", { staticClass: "section" }, [_c("DemoSection", { attrs: { "title": "Default", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ColorPicker", { model: { value: _vm.color, callback: function($$v) {
      _vm.color = $$v;
    }, expression: "color" } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("With Alpha")]), _c("DemoSection", { attrs: { "title": "Alpha", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ColorPicker", { attrs: { "hasAlpha": true }, model: { value: _vm.alphaColor, callback: function($$v) {
      _vm.alphaColor = $$v;
    }, expression: "alphaColor" } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Mini, with hex code selector")]), _c("DemoSection", { attrs: { "title": "Mini", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ColorPicker", { attrs: { "isMini": true }, model: { value: _vm.miniColor, callback: function($$v) {
      _vm.miniColor = $$v;
    }, expression: "miniColor" } })];
  }, proxy: true }]) })], 1), _c("div", { staticClass: "section" }, [_c("h3", [_vm._v("Mini, with icon (optional)")]), _c("DemoSection", { attrs: { "title": "MiniIcon", "code": _vm.demoCode }, scopedSlots: _vm._u([{ key: "components", fn: function() {
    return [_c("ColorPicker", { attrs: { "icon": "icon-text", "isMini": true }, model: { value: _vm.miniIconColor, callback: function($$v) {
      _vm.miniIconColor = $$v;
...
var _sfc_staticRenderFns = [function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "section" }, [_c("h1", [_vm._v("Color Picker")]), _c("p", [_vm._v("This color picker uses a chrome style picker")]), _c("pre", [_c("code", [_vm._v('import { ColorPicker } from "streamlabs-beaker"\n\ncomponents: {\n  ColorPicker\n}')])])]);
}, function() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
...
const ColorPickers = __component__.exports;
export {
  ColorPickers as default
};
