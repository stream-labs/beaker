...
<script lang="ts">
  ...
  export default class Button extends Vue {
    ...
    pressDown() {
      this.$el.classList.remove('pressDownEffectTiny', 'pressDownEffectSmall', 'pressDownEffectMedium', 'pressDownEffectLarge');
      ...
      if(buttonWidth <= 75) { this.$el.classList.add('pressDownEffectTiny'); };  
      if(buttonWidth >= 76 && buttonWidth <= 300) { this.$el.classList.add('pressDownEffectSmall'); };
      if(buttonWidth >= 301 && buttonWidth <= 500) { this.$el.classList.add('pressDownEffectMedium'); };
      if(buttonWidth >= 501) { this.$el.classList.add('pressDownEffectLarge'); };
    ...
    pressUp() {
      this.$el.classList.remove('pressDownEffectTiny', 'pressDownEffectSmall', 'pressDownEffectMedium', 'pressDownEffectLarge', 'pressUpEffect');
...
<style lang="less" scoped>
  ...
  .pressDownEffectTiny {
    animation: pressDownTiny .05s cubic-bezier(0.4, 0.0, 0.2, 1) forwards;
  }
   
  .pressDownEffectSmall {
    animation: pressDownSmall .05s cubic-bezier(0.4, 0.0, 0.2, 1) forwards;
  }

  .pressDownEffectMedium {
    animation: pressDownMedium .05s cubic-bezier(0.4, 0.0, 0.2, 1) forwards;
  } 

  .pressDownEffectLarge {
    animation: pressDownLarge .05s cubic-bezier(0.4, 0.0, 0.2, 1) forwards;
  }  
  ...
  @keyframes pressDownTiny {
    100% {
      transform: scale(.98);
    }
  }  

  @keyframes pressDownSmall {
    100% {
      transform: scale(.99);
    }
  }

  @keyframes pressDownMedium {
    100% {
      transform: scale(.994);
    }
  }

  @keyframes pressDownLarge {
    100% {
      transform: scale(.998);
    }
  }
